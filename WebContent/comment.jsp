					...
					<c:forEach var="comment" items="${commentList }">
						<li>
							<dl>
								...
								<dd class="author">
									网友：${comment.nickName } <span class="timer"> 评论时间：<fmt:formatDate
											value="${comment.createTime }" pattern="yyyy-MM-dd"
											type="date" /></span>
									<c:if test="${not empty comment.replyContent }">
										<dd>
											官方回复：${comment.replyContent }&nbsp;&nbsp;&nbsp;回复时间：
											<fmt:formatDate value="${comment.replyTime }"
