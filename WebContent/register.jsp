...
<script type="text/javascript">
	function checkUserName (value)
    {
	    if ($ ("#userName").val () == "")
	    {
		    // 	innerHtml是从对象的起始位置到终止位置的全部内容，包括html标签
		    // 	html是获取元素其中的内容，不含标签
		    // 	$("#userErrorInfo").innerHTML("");
				...
				<form id="regForm" method="post" action="user_register.action" onsubmit="return checkForm()">
					<table>
						...
						<tr>
							...
							<!-- onblur当用户名输入框失去焦点时的事件 -->
							<td><input class="text" type="text" id="userName" name="user.userName" onblur="checkUserName(this.value)" />&nbsp;<font
						...
						<tr>
							...
							<td><input type="radio" name="user.sex" value="男" checked="checked" />男&nbsp;&nbsp; <input type="radio" name="user.sex"
									value="女" />女</td>
						</tr>
						<tr>
							<td class="field">出生日期：</td>
							<td><input type="text" id="birthday" name="user.birthday" class="Wdate" onClick="WdatePicker()" /></td>
						</tr>
						<tr>
