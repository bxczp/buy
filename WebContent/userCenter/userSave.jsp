			...
			<table class="form">
				...
				<tr>
					...
					<td><input type="text" id="birthday" name="user.birthday"
							value="<fmt:formatDate value="${user.birthday }" type="date" pattern="yyyy-MM-dd"/>" class="Wdate" onClick="WdatePicker()" />
					</td>
				</tr>
				<tr>
				...
				<tr>
					<td><input type="hidden" name="user.id" value="${user.id }" /> <input type="hidden" name="user.status"
