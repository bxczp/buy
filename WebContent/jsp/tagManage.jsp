...
<body style="margin: 1px;">
	<!-- 分别是 列适应 分页显示 行号显示 请求地址 自适应 工具栏 -->
	<table id="dg" title="标签管理" class="easyui-datagrid" fitColumns="true" pagination="true" rownumbers="true" url="tag_list.action"
		fit="true" toolbar="#tb">
		<thead>
			<tr>
	...
	<div id="tb">
		...
		<div>
			&nbsp;标签名称：&nbsp;
			<input type="text" name="s_tag.name" id="s_tagName" size="20" onkeydown="if(event.keyCode==13) searchTag()" />
	...
	<div id="dlg" class="easyui-dialog" style="width: 550px; height: 200px; padding: 10px 20px" closed="true" buttons="#dlg-buttons">
		<form id="fm" method="post">
			<table cellspacing="8px;">
				...
				<tr>
					<td>标签地址：</td>
					<td colspan="4"><input type="text" id="url" name="tag.url" class="easyui-validatebox" required="true" validtype="url"
