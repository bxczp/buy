...
<body style="margin: 1px;">
	...
	<div id="tb">
		...
		<div>
			&nbsp;留言名称：&nbsp;
			<input type="text" name="s_comment.name" id="s_commentTitle" size="20" onkeydown="if(event.keyCode==13) searchComment()" />
		...
		<form id="fm" method="post">
			<table cellspacing="8px;">
				<tr>
					...
					<td colspan="4"><textarea id="content" name="comment.content" rows="4" cols="40" readonly="readonly"></textarea></td>
				</tr>
				<tr>
					<td valign="top">回复内容：</td>
					<td colspan="4"><textarea id="replyContent" name="comment.replyContent" rows="4" cols="40"></textarea> <input
							type="hidden" id="id" name="comment.id" /> <input type="hidden" id="nickName" name="comment.nickName" /> <input
							type="hidden" id="createTime" name="comment.createTime" /></td>
				</tr>
			</table>
		</form>
	</div>
