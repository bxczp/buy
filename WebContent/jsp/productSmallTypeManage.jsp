...
<script type="text/javascript">
    ...
    function deleteProductSmallType ()
    {
	    ...
	    $.messager.confirm ("系统提示", "您确认要删掉这<font color=red>" + selectedRows.length + "</font>条数据吗？", function (r)
	    {
		    if (r)
		    {
			    $.post ("productSmallType_delete.action",
			    {
				    ids : ids
			    }, function (result)
			    {
...
<body style="margin: 1px;">
	...
	<div id="tb">
		...
		<div>
			&nbsp;商品小类名称：&nbsp;
			<input type="text" name="s_productSmallType.name" id="s_productSmallTypeName" size="20"
				onkeydown="if(event.keyCode==13) searchProductSmallType()" />
	...
	<div id="dlg" class="easyui-dialog" style="width: 670px; height: 350px; padding: 10px 20px" closed="true" buttons="#dlg-buttons">
		<form id="fm" method="post">
			<table cellspacing="8px;">
				<tr>
					<td>所属大类：</td>
					<td colspan="4"><input class="easyui-combobox" id="bName" name="productSmallType.bigType.id"
				...
				<tr>
					<td valign="top">备注：</td>
					<td colspan="4"><textarea rows="7" cols="50" name="productSmallType.remarks" id="remarks"></textarea></td>
				</tr>
			</table>
		</form>
	</div>
