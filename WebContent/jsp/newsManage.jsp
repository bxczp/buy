...
<body style="margin: 1px;">
	<table id="dg" title="新闻管理" class="easyui-datagrid" fitColumns="true" pagination="true" rownumbers="true" url="news_list.action"
		fit="true" toolbar="#tb">
		<thead>
			<tr>
	...
	<div id="tb">
		...
		<div>
			&nbsp;新闻名称：&nbsp;
			<input type="text" name="s_news.name" id="s_newsTitle" size="20" onkeydown="if(event.keyCode==13) searchNews()" />
	...
	<div id="dlg" class="easyui-dialog" style="width: 750px; height: 450px; padding: 10px 20px" closed="true" buttons="#dlg-buttons">
		<form id="fm" method="post">
			<table cellspacing="8px;">
				<tr>
					<td>新闻标题：</td>
					<td colspan="4"><input type="text" id="title" name="news.title" class="easyui-validatebox" required="true"
							style="width: 300px;" /></td>
				</tr>
				<tr>
					<td valign="top">新闻内容：</td>
					<td colspan="4"><textarea class="ckeditor" id="content" name="news.content"></textarea> <input type="hidden"
							id="createTime" name="news.createTime" /></td>
				</tr>
			</table>
		</form>
	</div>
